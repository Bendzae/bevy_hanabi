...
mod tests {
    ...
    fn make_test_item() -> BatchInput {
        ...
        let image_handle_id = AssetId::default::<Image>();
    ...
    fn effect_batch_texture_same() {
...

        {
            ...
            let mut item1 = make_test_item();
            item1.image_handle_id = AssetId::random::<Image>();
    ...
    fn effect_batch_texture_different() {
...

        {
            ...
            let mut item1 = make_test_item();
            item1.image_handle_id = AssetId::new(Image::TYPE_UUID, 1);

            let mut item2 = item1.clone();
            item2.effect_slice.slice = 100..200;
            item2.image_handle_id = AssetId::new(Image::TYPE_UUID, 2);
    ...
    fn effect_batch_texture_mixed() {
...

        {
            ...
            item2.image_handle_id = AssetId::random::<Image>();
